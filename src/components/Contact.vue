<template>
    <section id="projects" class="p-8 text-center bg-[#fce301]">
        <h2 class="text-4xl font-extrabold mb-8 text-black">CONTACT</h2>
        <form>
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 px-20">
                <div>
            ...
            <div class="mt-10 mx-20">
                <button type="submit"
                    class="block w-full rounded-md bg-black px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Let's
                    talk</button>
            </div>
        </form>
    </section>
