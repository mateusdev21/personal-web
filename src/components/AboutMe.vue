<template>
    <section id="about" class="p-8 bg-black">
        <h2 class="text-5xl text-[#fce301] font-bold mb-4">Get To Know Me</h2>
        <h3 class="text-2xl text-white font-bold mb-2">Who Am I ?</h3>
        <p class="leading-relaxed text-white mb-4">
            Experienced frontend developer with 3 years of expertise, specializing in Vue.js. Proficient in HTML, CSS,
            JavaScript, and responsive interface design. Experienced in integrating backend APIs. Committed to staying
            updated with the latest technology developments.
        </p>
        <h3 class="text-2xl text-white font-bold mb-4">Skills</h3>
        <div class="flex items-center flex-wrap">
            <!-- HTML -->
            <span class="mb-6 pa-4 mr-2 hover:cursor-pointer">
                <svg role="img" width="40" class="mr-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <title>HTML5</title>
                    <path fill="#e5532d"
            ...
            <!-- CSS -->
            <span class="mb-6 pa-4 mr-6 hover:cursor-pointer">
            ...
            <!-- Tailwind -->
            <span class="mb-6 pa-4 hover:cursor-pointer">
                <svg role="img" width="40" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
